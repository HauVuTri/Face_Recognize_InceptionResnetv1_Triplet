...
# Hàm tìm Euclidean distance giữa 2 Faces
...
enc_trainer_model.compile(optimizer=Adam(lr=0.0005), loss = None)
...
for e in range(1,epochs+1):
  ...
  # if(e%2 == 0):
  print("Triplet Loss sau 1 epick "+str(e)+' epochs có giá trị : '+str(loss))


# Save the encoder model weights for future use

save_location = "save_model_weights2.h5"
